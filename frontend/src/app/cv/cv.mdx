...
**Backend:** FastAPI, FastAPI, Alembic, SQLAlchemy, SQLModel, PostgreSQL, Redis, Celery, Express
...
*Gap due to major concussion in March 2016. Continued in an advisory role during the interim*
